+++ 
draft = false
date = 2019-12-28T09:00:00+09:00
title = "Selenium 4新機能: Chrome DevTools Protocol"
description = ""
slug = "selenium4-chrome-devtools-protocol" 
tags = ["Selenium", "Selenium4", "testing", "automation", "Advent Calendar", "Google Chrome"]
categories = []
externalLink = ""
series = []
isCJKLanguage = true
aliases = ["/2019/12/28/selenium4-chrome-devtools-protocol.html"]
+++

この記事は[Selenium/Appium Advent Calendar 2019](https://qiita.com/advent-calendar/2019/selenium_and_appium)の14日目の記事です。[^1]

[3日目の記事](/2019/12/03/selenium4-new-features-alpha/)ではSelenium 4の新機能をざっと紹介しました。[11日目の記事](/2019/12/11/selenium4-relative-locator/)では新機能のひとつであるRelative Locatorについて解説しました。
