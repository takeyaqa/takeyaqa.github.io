+++ 
draft = false
date = 2018-12-14T09:00:00+09:00
...
series = []
isCJKLanguage = true
images = ["/images/2018/12/14/01_selenium-ide.png"]
aliases = ["/2018/12/14/selenium-ide-tutorial.html"]
+++

**内容を2019年版に更新した記事を作成しました！**
**[Selenium IDEで「はじめよう自動化」ver.2019](/2019/12/23/selenium-ide-tutorial-2019/)**
...
![selenium-ide-01](/images/2018/12/14/01_selenium-ide.png)
...
![selenium-ide-03](/images/2018/12/14/03_selenium-ide.png)
...
![selenium-ide-04](/images/2018/12/14/04_selenium-ide.gif)
...
![selenium-ide-05](/images/2018/12/14/05_selenium-ide.png)

テストケースの名称を入力されるように促されるので、任意の名前を入力します。テストの内容やパターンがわかりやすい名前にするのがいいでしょう。これで記録は完了です。

## テストの実行

![selenium-ide-06](/images/2018/12/14/06_selenium-ide.png)
...
![selenium-ide-07](/images/2018/12/14/07_selenium-ide.png)
